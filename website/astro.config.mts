...
import { languagesAvailable, defaultLang , } from "./src/i18n/language.config";
import type { LanguageAvailable } from "./src/i18n/language.config";
...
export const astroConfig: AstroUserConfig = {
  ...
  i18n: {
    locales: Object.keys(languagesAvailable),
    defaultLocale: defaultLang,
    fallback: {
      fr: 'en',
      pt: 'en',
      // de: 'en', 
    } as Record<LanguageAvailable, LanguageAvailable>,
    routing: {
